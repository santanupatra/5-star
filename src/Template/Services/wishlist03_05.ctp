                  ...
                  <div class="post-wrap mb-3">
                     ...
                     <div class="right-side">
                        ...
                        <ul class="posted-extra-links d-flex list-unstyled mb-0 py-1">
                           <li><a href="javascript: like(<?php echo $service->Services->id;?>);" id='like_<?php echo $service->Services->id;?>'><i class="ion-ios-heart" <?php echo (($likes == 1)? 'style="color: #d8ad57"' : '');?>></i> Like</a></li>
...
<!--                           <li><a href="javascript: report(<?php echo $service->Services->id;?>);" id='report_<?php echo $service->Services->id;?>'><i class="ion-ios-information" <?php echo (($reports == 1)? 'style="color: #d8ad57"' : '');?>></i> Report</a></li>-->
                           ...
                           <li><a href="<?php echo $this->request->webroot;?>services/details/<?php echo $service->Services->id;?>" ><i class="ion-ios-information" ></i> Reserve</a></li>
                              ...
                              <div class="row">
                                 <div class="col-md-10">
                                  <div class="post-dashboard d-flex">
                                    ...
                                    <input type="button" value="Post" class="btn btn-primary text-white text-center ml-md-3 mt-md-2 rounded-0 text-uppercase" onclick="javascript:addcomment(<?php echo $service->Services->id;?>)">   
                                  </div>
                                 </div>
                              </div>
