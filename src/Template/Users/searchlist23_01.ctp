      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            ...
            <div class="row">
                <?php if(!empty($top_result)){ foreach($top_result as $dt){?>
              ...
              <div class="col-lg-6">
                ...
                <div class="card">
                  <div class="hdr">
                    <div class="img" style="background-image: url('<?php echo $this->Url->build('/user_img/'.$dt['details']['user']['pimg']); ?>')"></div>
                    <div class="txt">
                      <h4><?php echo $dt['details']['user']['full_name']?></h4>
                      <p><?php echo $dt['details']['service_name']?></p>
                    </div>
                    
                    <?php if($dt['details']['id']==$dt['favourite']['service_id']){?>
                    <a href="javascript:void(0)" onclick="chk_add_to_faviouritelist_valid('<?php echo $dt['details']['id'];?>')"><div class="love text-gray" id="love_<?php echo $dt['details']['id'];?>">
                        <i class="fa fa-heart" aria-hidden="true"></i>
                </div></a>
                    <?php }else{ ?>
                    <a href="javascript:void(0)" onclick="chk_add_to_faviouritelist_valid('<?php echo $dt['details']['id'];?>')"><div class="love" id="love_<?php echo $dt['details']['id'];?>">
                        <i class="fa fa-heart" aria-hidden="true"></i>
                </div></a>
                    
                    <?php } ?>
                  </div>
                    <a href="<?php echo $this->Url->build(["controller" => "Users","action" => "servicedetails",$dt['details']['id']]);?>"><div class="img-prt" style="background-image: url('<?php echo $this->Url->build('/service_img/'.$dt['details']['image']); ?>')"></div></a>
                  
                  <div class="btn-grp">
                      <?php foreach($dt['details']['service_provider_tags'] as $t){?>
                  ...
                  <div class="moreTxt">
                    ...
                    <a href="<?php echo $this->Url->build(["controller" => "Users","action" => "servicedetails",$dt['details']['id']]);?>">Read More >></a>
                  </div>
                  <div class="ftr-rtng">
                    <span>Rating</span>
                  ...
                  <i aria-hidden="true" class="fa fa-share-alt" onclick="a('<?php echo $dt['details']['id'];?>')"></i>
                  <div class="pop-up-box" id="share_<?php echo $dt['details']['id'];?>" style="display: none">
                  	<div class="arrow_box">
						<ul>
                                                    <li><a href="javascript:void(0);" class="share_fb" onclick="facebook_share('<?php echo $dt['details']['id'];?>','<?php echo $dt['details']['image'];?>','<?php echo $dt['details']['description']?>')"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
							<li><a href="javascript:twShare('http://111.93.169.90/team6/jimja/users/servicedetails/<?php echo $dt['details']['id'];?>', '<?php echo $sitesetting['SiteSetting']['twitter_share_text'];?>', '', 'http://111.93.169.90/team6/jimja/service_img/<?php echo $dt['details']['image'];?>', 520, 350)" class="share_tweet"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
                                                    <li><a href="https://plus.google.com/share?url=http://111.93.169.90/team6/jimja/users/servicedetails/<?php echo $dt['details']['id'];?>" onclick="javascript:window.open(this.href,'', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600');return false;" class="share_gplus"><i class="fa fa-google-plus" aria-hidden="true"></i></a></li>
						</ul>                 	
                </div>
                  </div>                  
                </span>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3">
            ...
            <div class="card">
              <div class="hdr">
                <div style="background-image: url('<?php echo $this->Url->build('/user_img/'.$dt['details']['user']['pimg']); ?>" class="img"></div>
                <div class="txt">
                  <h4><?php echo $dt['details']['user']['full_name']?></h4>
                  <p><?php echo $dt['details']['service_name']?></p>
                </div>
                ...
                <a href="<?php echo $this->Url->build(["controller" => "Users","action" => "servicedetails",$dt['details']['id']]);?>"><div style="background-image: url('<?php echo $this->Url->build('/service_img/'.$dt['details']['image']); ?>')" class="img-prt"></div></a>
...
<script type="text/javascript">
    ...
    <?php foreach($result as $res){ ?>
          {
            position: new google.maps.LatLng(<?php echo $res['latitude']?> , <?php echo $res['longitude']?>),
            type: 'info'
          }, 
<?php } ?>
