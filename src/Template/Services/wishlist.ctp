   ...
   <div class="row">
      ...
      <div class="col-lg-9 col-md-8">
            ...
            <div class="recent-post-wrap">
                <h5 class="common-title mb-0 p-3">Wishlist</h5>
                     ...
                     if(count($services) > 0){
                       foreach($services as $service){
                        ...
                        $post_date = $service['created']; 
                         ...
                         $likes = 0;
                         $reports = 0;
                         //foreach ($service['is_likes'] as $like) {
                           if($service['is_likes'])
                               {
                                 $likes = 1;
                               }
                  ...
                  <div class="post-wrap mb-3">
                     <div class="left-side mr-2">
                        <?php
                           if($service['uids'] != $uid){
                           ?>
                        <a href="javascript: select_friend_foot(<?php echo $service['uids'];?>)" class="d-inline-block">
                           <div class="user userCurrent" data-id=<?php echo $service['uids'];?>><img src="<?php echo $this->request->webroot;?>/user_img/thumb_<?php echo (($service['pimg'] != "")? $service['pimg'] : 'nouser.png');?>" class="user-image rounded-circle img-fluid d-inline-block" alt=""></div>
                        </a>
                        <?php
                           }
                           else{
                           ?>
                        <img src="<?php echo $this->request->webroot;?>/user_img/thumb_<?php echo (($service['pimg'] != "")? $service['pimg'] : 'nouser.png');?>" class="user-image rounded-circle img-fluid d-inline-block" alt="">
                        <?php
                           }
                           ?>
                        <div class="marge-text d-inline-block">
                           <p class="name mb-0"><?php if($service['business_name'] ==""){echo $service['full_name'];}else{echo $service['business_name'];}?></p>
                     ...
                     <div class="right-side">
                        <div class="post-image mb-2 w-100 float-left">
                           ...
                           <section class="home-slider">
                              <div id="carouselExampleIndicators_<?php echo '208';?>" class="carousel slide" data-ride="carousel">
                                 <div class="carousel-inner">
                                    ...
                                    <ol class="carousel-indicators">
                                       <?php 
                                          if(count($service['service_images'])>1){
                                            foreach($service['service_images'] as $imgs){?>
                                       <li data-target="#carouselExampleIndicators_<?php echo '208';?>" data-slide-to="0" <?php echo (($i == 0)? 'class="active"' : '');?>></li>
                                       <?php 
                                          $i++;
                                            } 
                                          }
                                    ...
                                    <?php 
                                       foreach($service['service_images'] as $imgs){?>                
                                    <div class="carousel-item <?php echo (($a == 1)? 'active' : '');?>">
                                       <a href="<?php echo $this->request->webroot;?>services/details/<?php echo $service['sid']?>"><img src="<?php echo $this->request->webroot;?>service_img/<?php echo (($imgs->name != "")? $imgs->name : 'nouser.png');?>" alt="..." class="w-100"></a>
                                       <div class="carousel-caption d-flex flex-column flex-wrap align-items-center justify-content-center">
                                       </div>
                                    </div>
                                    <?php $a++; }} ?>
                                    <a class="carousel-control-prev" href="#carouselExampleIndicators_<?php echo '208';?>" role="button" data-slide="prev">
                                    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                    <span class="sr-only">Previous</span>
                                    </a>
                                    <a class="carousel-control-next" href="#carouselExampleIndicators_<?php echo '208';?>" role="button" data-slide="next">
                        ...
                        <p class="like-comment text-right mb-2">
                           <a href="javascript: all_like(<?php echo $service['pid'];?>);"><span id="nolike_<?php echo $service['pid'];?>"><?php echo $service['like_count'];?></span> <span class="grey-text">Likes</span></a>   <span class="grey-text"> |</span>
                           <a href="javascript: comment(<?php echo $service['pid'];?>);"><span id="nocomment_<?php echo $service['pid'];?>"><?php echo $service['comment_count'];?></span> <span class="grey-text">Comment</span></a>
                        </p>
                        <ul class="posted-extra-links d-flex list-unstyled mb-0 py-1">
                           <li><a href="javascript: like(<?php echo $service['pid'];?>);" id='like_<?php echo $service['pid'];?>'><i class="ion-ios-heart" <?php echo (($likes == 1)? 'style="color: #d8ad57"' : '');?>></i> Like</a></li>
                           <li><a href="javascript: comment(<?php echo $service['pid'];?>);"><i class="ion-ios-chatbubble-outline"></i> Comment</a></li>
                           <li class="dropup social-share">
                              <a data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="ion-android-share-alt"></i> Share</a>
                           ...
                           <?php if($service['pid']!=""){?>
                           <li><a href="<?php echo $this->request->webroot;?>services/details/<?php echo $service['sid']?>" id='report'><i class="ion-ios-information"></i>Reserve</a></li>
                           <?php } ?>
                        </ul>
                        <!-- +++++++++++++++Comment++++++++++++++-->
                        <div class="foo w-100 bg-light p-md-2 float-left" style="display: none;" id="comment_<?php echo $service['pid'];?>">
                           <div class="form-group">
                              <div class="post-dashboard d-flex" id="commentbox_<?php echo $service['pid'];?>">
                                 <textarea id="ctext_<?php echo $service['pid'];?>" class="form-control form-control-sm" cols="5" rows="2" placeholder="Message Here. . . ."></textarea>
                                 
                                 <button type="button" value="Post" class="btn btn-primary text-white text-center ml-md-3 mt-md-2 rounded-0 text-uppercase n-btn" onclick="javascript:addcomment(<?php echo $service['pid'];?>)">
                                  <i class="icon ion-android-send text-white"></i>
                                 </button>
                              </div>
                              <div class="row" style="height: 10px"></div>
                              <div class="row">
                                 <div class="col-md-12" id="all_comment_<?php echo $service['pid'];?>">
                                 </div>
                              </div>
                           </div>
                        </div>
                        <!-- +++++++++++++++Comment End++++++++++++++--> 
                        <!-- +++++++++++++++Like++++++++++++++-->
                        <div class="foo w-100 bg-light p-md-2 float-left" style="display: none;" id="likelike_<?php echo $service['pid'];?>">
                           <div class="form-group">
                              <div class="row" style="height: 10px"></div>
                              <div class="row">
                                 <div class="col-md-12" id="all_like_<?php echo $service['pid'];?>">
                                 </div>
                              </div>
                           </div>
                        </div>
