...
<section class="home-banner" style="background: url(<?php echo $this->request->webroot;?>slider_img/<?php echo $banner->image;?>) no-repeat top center;">
		<div class="container">
			<div class="row">
				<div class="col-lg-8 col-md-10 ml-auto mr-auto text-center">
					...
					<p class="mt-4 mb-0"><img src="<?php echo $this->request->webroot;?>logo/<?php echo $SiteSettings['site_logo'];?>" alt="" class="img-fluid"></p>
					<h1 class="text-uppercase mt-4"><?php echo $banner->title;?></h1>
					<h6 class="mb-4"><?php echo $banner->description;?></h6>
				</div>
			</div>
		</div>
	</section>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12 col-md-12">
					<h1 class="mb-5"><?php echo trim($how_it_work->page_title); ?></h1>
				</div>
					<?php echo trim(nl2br($how_it_work->content)); ?>
	    			...
	    			<ul class="list-unstyled">
						...
						<li>
							...
							<article>
                                ...
                                echo ((isset($service['fav']))? 'style="color: red;"' : '');?>></i></a>
								<p class="rating mb-1">
								<div style="float: left; width: 65%"> <span class="stars"><?php if($service['avrating']!=''){echo $service['avrating'];}else{echo 0;};?></span>
								(<?php echo $service['rcount'];?>)</div>
								<div style="float: left; width: 35%"><a href="<?php echo $this->Url->build(["controller" => "Services","action" => "details",$service['id']]);?>" class="btn btn-primary btn-block btn-sm text-capitalize mb-2">Reserve</a></div>                              
								</p>
