                    ...
                    <div class="row product-list-row">
                        ...
                        <div class="col-lg-6 col-md-6 col-12">
                           ...
                           <p class="text-grey">Contact Email: <?php echo $service->service->cp_email;?></p>
                            ...
                            <p class="text-grey">Event Booked By: <?php echo $service->user->full_name;?></p>

                            <p class="text-grey">Event Date: <?php echo $service->service->start_time;?> to <?php echo $service->service->end_time;?></p>
                            <p class="text-grey">Reserved Date & Time: <?php echo $service->event_date;?> - <?php echo date('h:i A',strtotime($service->event_time));?></p>
