		...
		<div class="row">
            ...
            <div class="col-lg-9 col-md-8">
				<div class="edit-pro p-3 p-lg-4">
                    ...
                    <h5 class="common-title mb-3 pb-2 justify-content-between d-flex"><span>Booking History</span>  <span>Total Amount:$ <?php echo number_format($total[0]['t'],2);?></span> </h5>
                    ...
                    <?php if($orders!=''){
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-12">
                            ...
                            <p class="text-grey mb-0">Amount Pay:$ <?php echo number_format($ord->total_amount,2);?></p>
                            
         
                        </div> 
                        <div class="col-lg-3 col-md-3 col-12 text-md-right pt-md-5">  
                        <?php if($ord->is_view == 1){?>            
                             <a href="<?php echo $this->Url->build(["controller" => "Services","action" => "bookingdetails1",  $ord->id]);?>" class="btn btn-sm btn-danger">View</a>
                             <?php }else{?>
                             <a href="<?php echo $this->Url->build(["controller" => "Services","action" => "bookingdetails1",  $ord->id]);?>" class="btn btn-sm btn-success">View</a>
                             <?php } ?>
                          <a href="<?php echo $this->Url->build(["controller" => "Services","action" => "sellerbookingdelete",  $ord->id]);?>" class="btn btn-sm btn-danger">delete</a>  
