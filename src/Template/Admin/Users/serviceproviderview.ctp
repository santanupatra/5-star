            ...
            <div class="runs view large-9 medium-8 columns content">
                ...
                <table class="vertical-table table table-striped table-bordered table-hover">
                    ...
                    <tr>
                        ...
                        <td><?php echo h($users->business_name) ?></td>
                    </tr>
                    ...
                    <tr>
                     ...
                     <tr>
                        <th><?php echo __('Accounts Contact') ?></th>
                        <td><?php echo $users->acc_contact ?></td>
                    </tr> 
                    
                     <tr>
                        <th><?php echo __('Accounts Email') ?></th>
                        <td><?php echo $users->acc_email ?></td>
                    </tr> 
                    
                     <tr>
                        <th><?php echo __('Accounts Telephone') ?></th>
                        <td><?php echo $users->acc_phone ?></td>
                    </tr> 
