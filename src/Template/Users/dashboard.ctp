            ...
            <form class="form-horizontal custom_horizontal" name="PhotoGallery" id="postfrm" action="" method="post" enctype="multipart/form-data">
               ...
               <div class="msg-bottom px-3 py-2">
                  <ul class="d-flex list-unstyled mb-0">
                     ...
                     <li class="w-100 float-left d-block text-right"><a class="btn btn-primary mb-0 rounded-0 py-1" id="imgp" href="javascript:void(0);" style="margin-bottom:5px;">Post</a></li>
                  </ul>
            </form>
            </div> 
            <div class="recent-post-wrap">
            <?php if($type == 'U'){ ?>
          <h5 class="common-title mb-0 p-3"> <span class="pl-2"><a href="<?php echo $this->request->webroot;?>users/dashboard"> Recent Posts</a></span> My post </h5>
          <?php }else{ ?>
          <h5 class="common-title mb-0 p-3">Recent Posts <span class="pl-2"><a href="<?php echo $this->request->webroot;?>users/dashboard/U">My post</a></span></h5>
          <?php } ?>
                <!-- <h5 class="common-title mb-0 p-3">Recent Posts <span class="pl-2"><a href="<?php echo $this->request->webroot;?>users/dashboard/U">My post</a></span></h5> -->
                  ...
                  <div class="post-wrap mb-3">
                     <div class="left-side mr-2">
                        <?php
                           ...
                           ?>
                        <a href="javascript: select_friend_foot(<?php echo $service->user->id;?>)" class="d-inline-block">
                           <div class="user userCurrent" data-id=<?php echo $service->user->id;?>><img src="<?php echo $this->request->webroot;?>/user_img/thumb_<?php echo (($service->user->pimg != "")? $service->user->pimg : 'nouser.png');?>" class="user-image rounded-circle img-fluid d-inline-block" alt=""></div>
                        </a>
                        <?php
                           }
                           else{
                     ...
                     <div class="right-side">
                        ...
                        <div class="foo w-100 bg-light p-md-2 float-left" style="display: none;" id="comment_<?php echo $service['id'];?>">
                           <div class="form-group">
                              <div class="post-dashboard d-flex" id="commentbox_<?php echo $service['id'];?>">
