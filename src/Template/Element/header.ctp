<div class="modal fade" id="loginModal" tabindex="-1" role="dialog" aria-labelledby="loginModal" aria-hidden="true">
  ...
  <div class="modal fade" id="registerModal" tabindex="-1" role="dialog" aria-labelledby="registerModal" aria-hidden="true">
    <div class="modal-dialog" role="document">
      ...
      <div class="modal-body">
        <a href="#" class="btn btn-block mb-3 button-fb" onclick="flogin()"><i class="ion-social-facebook"></i> Connect with Facebook</a>
...
<nav class="navbar navbar-expand-lg navbar-toggleable-md fixed-top navbar-light bg-light ">
    <div class="container">
        ...
        <a class="navbar-brand d-sm-block desktop-nav" href="<?php echo $this->Url->build(["controller" => "Users","action" => "index"]);?>"><img src="<?php echo $this->request->webroot;?>logo/<?php echo $SiteSettings['site_logo'];?>" alt="" style="width: 55px;" /></a>

        <a class="navbar-brand d-sm-block mobile-nav" href="<?php echo $this->Url->build(["controller" => "Users","action" => "index"]);?>"><img src="<?php echo $this->request->webroot;?>logo/logo_mobile.png" alt="" style="width: 55px;" /></a>
...
<!--          <li class="nav-item">
            <a class="nav-link" id="chatbox" href="#">Messages
              <span class="mcount"><b>0</b></span>
            </a>
          </li>-->
         ...
         if(isset($user_id)){?>
          ...
          <?php  if($user_details['utype'] == 1){ ?>
            ...
            <li class="nav-item">
              <a class="nav-link" href="<?php echo $this->Url->build(["controller" => "Users","action" => "editprofile"]);?>">Edit Profile</a>
            </li>
            ...
            <?php }else{ ?>
              ...
              <li class="nav-item">
              <a class="nav-link" href="<?php echo $this->Url->build(["controller" => "Users","action" => "serviceeditprofile"]);?>">Edit Profile</a>
            </li>
            ...
            <?php } ?>
              ...
              <li class="nav-item">
              <a class="nav-link" href="<?php echo $this->Url->build(["controller" => "Users","action" => "changepass"]);?>">Change Password</a>
            </li>
          ...
          <li class="nav-item">
           ...
           <li class="nav-item">
            <a class="nav-link" href="<?php echo $this->Url->build(["controller" => "Users","action" => "signin"]);?>">Log In</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="<?php echo $this->Url->build(["controller" => "Users","action" => "signup"]);?>">Register</a>
          </li>
          <?php
            }
          ?>
          <!--  <li class="nav-item cart-item">
              <a href="#" id="chatbox" class="nav-link">
                <img src="<?php echo $this->request->webroot;?>img/chat.png" style="width:50px">
              </a>
            </li> -->
         <!--  <li class="nav-item cart-item">
            <a href="#" class="nav-link" id="chatbox"><i class="ion-chatbox-working"></i><span><?php echo((isset($awaiting_payment) && !empty($awaiting_payment))?'<b>'.$awaiting_payment.'</b>':'<b>0</b>' );?></span></a>
          </li> -->
          <!-- <li class="nav-item cart-item">
              <a href="<?php echo $this->request->webroot;?>services/cart" class="nav-link"><i class="ion-android-cart"></i><span><?php echo((isset($awaiting_payment) && !empty($awaiting_payment))?'<b>'.$awaiting_payment.'</b>':'<b>0</b>' );?></span></a>
            </li> 


          <li class="nav-item">
            <?php if(!isset($user_id)){?>
              <a href="#" data-toggle="modal" data-target="#loginModal" class="btn btn-primary">Add Venues</a>
            <?php
             }
             else{
                echo '<a href="'.$this->Url->build(["controller" => "Services","action" => "addservice"]).'" class="btn btn-primary">Add Venues</a>';
             }
             ?>
          </li>-->
        </ul>
