                  ...
                  <div class="post-wrap mb-3">
                     ...
                     <div class="right-side">
                        <div class="post-image mb-2 w-100 float-left">
                           ...
                           <div class="slider-maindiv w-100 float-left">
                              <div id="wowslider-container1">
                                 <div class="ws_images">
                                    <ul>
                                       <li><img src="/team6/5star/images/1.jpg" alt="" id="wows1_0" class="img-fluid" />
                        ...
                        <p class="like-comment text-right mb-2">
                           ...
                           <span id="nocomment_<?php echo $service['id'];?>"><?php echo count($service->comments);?></span> <span class="grey-text">Comment</span>
                        </p>
