...
class ServicesController extends AppController {
    ...
    public function initialize() {
        ...
        $this->Auth->allow(['result', 'add_favourite', 'details','ajaxaddtocart','purchasepayment','ajaxaddtocartDetails','latestrequestfootercount']);
...
public function servicestatus($eid = null,$status=null) {
 ...
 $user_id = $this->request->session()->read('Auth.User.id');
        ...
        $amenities = $this->Amenities->find()->where(['id IN' => $aid])->toArray();
         ...
         $all_review=  $this->Ratings->find()->contain(['Users'])->where(['Ratings.rated_to'=>$service->provider_id])->toArray();
...
public function mybooking1() {
        ...
        $conditions = ['Orders.owoner_id'=>$uid];
     ...
     public function requestconfirm($id=NULL)
        {
            ...
            $service = $this->TempCarts->patchEntity($service, $temp);
                ...
                if($this->TempCarts->save($service))
                {
                    ...
                    $chat_val['message'] = 'Your request for event '.$this->request->data['service_name'].' is accepted. Please complete the payment process to join this event';
                    ...
                    $this->Flash->success('Request successfully Accepted.', 'default', array('class' => 'success'));
                    }
                    return $this->redirect(['action' => 'bookingrequest']);
        }
...
//echo $Current_woner_id;exit;
                ...
                {
                     $Msg = array('Ack'=>1, 'data'=> 'Service request already sent.');
                }
            }
        }
...
public function paymentsuccess()
{
  ...
  public function salesdetails($id) {
   ...
   public function latestrequestfootercount() {
      ...
      $msgcount = $this->TempCarts->find()->where(['TempCarts.service_owner_id' => $userid,'TempCarts.is_accept' => 0])->toArray();
