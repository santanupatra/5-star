                    ...
                    <div class="row product-list-row">
                        ...
                        <div class="col-lg-6 col-md-6 col-12">
                         ...
                         <div class="col-lg-3 col-md-3 col-12 text-md-right pt-md-5">              
                          ...
                          <a href="javascript: select_friend_foot(<?php echo $dt->company->id;?>)"  style="display: inline-block" class="btn btn-primary text-capitalize rounded-0 btn-sm"> <div class="user userCurrent" data-id=<?php echo $dt->company->id;?> style="color: #fff; "> <?php if($dt->company->is_active==1){?> <span class="on_line on_<?php echo $dt->company->id;?>" ><i class="" aria-hidden="true"></i></span><?php }else{ ?><span class="off_line off_<?php echo $dt->company->id;?>"><i class="ion-chatbox" aria-hidden="true"></i></span><?php } ?>
                                chat now
                            </div></a>   
